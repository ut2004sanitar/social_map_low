...
L.Control.Search = L.Control.extend({
	...
	options: {
		...
		propertyName: 'objname',		//property in marker.options(or feature.properties for vector layer) trough filter elements in layer
		...
		textErr: 'Не найдено',	//error message
		position: 'topleft',
